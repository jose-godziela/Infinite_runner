...
int Character::get_mov_key_UP() 
{
	return _mov_key_up; 
}

int Character::get_mov_key_DOWN() 
{
	return _mov_key_down; 
}

int Character::get_jump_key() 
{ 
	return _jump_key;
}

Rectangle Character::get_rec() 
{ 
	return _rec;
}

int Character::get_mov_key_LEFT() 
{ 
	return _mov_key_left; 
}
int Character::get_mov_key_RIGHT()
{ 
	return _mov_key_right;
}
